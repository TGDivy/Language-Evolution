...
class Scenario(BaseScenario):
    ...
    def observation(self, agent, world):
        ...
        landmarks = []
        for entity in world.landmarks:
            rotate_pos = entity.state.p_pos - agent.state.p_pos
            landmarks.append(np.concatenate([rotate_pos, entity.color]))
        ...
        #     [agent.state.p_vel]  # + entity_pos + entity_color + [goal_color[1]] + comm
        # )
