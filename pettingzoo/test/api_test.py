...
def test_observation_action_spaces(env, agent_0):
    assert not hasattr(env, "action_spaces") or isinstance(
        env.action_spaces, dict
    ), "action_spaces must be a dict"
    assert not hasattr(env, "observation_spaces") or isinstance(
        env.observation_spaces, dict
    ), "if observation_spaces exists, it must be a dict"
