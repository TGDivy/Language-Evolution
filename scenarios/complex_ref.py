...
class Scenario(BaseScenario):
    ...
    def reset_world(self, world, np_random):
        ...
        world.agents[1].goal_a = world.agents[2]
        world.agents[1].goal_b = np_random.choice(world.landmarks)
        world.agents[2].goal_a = world.agents[3]
        world.agents[2].goal_b = np_random.choice(world.landmarks)
        world.agents[3].goal_a = world.agents[0]
        ...
        world.agents[2].goal_a.color = world.agents[2].goal_b.color
        world.agents[3].goal_a.color = world.agents[3].goal_b.color
    ...
    def observation(self, agent, world):
        ...
        for other in world.agents:
            ...
            entity_color.append(other.color)

        return np.concatenate(
            [agent.state.p_vel] + entity_pos + entity_color + goal_color + comm
        )
