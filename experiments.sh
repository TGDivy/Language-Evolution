...
python run.py --model "ppo_shared_global_critic_rec" --env "simple" --experiment_name "-" --num-envs 512 --total-timesteps 15000 --num-minibatches 1 --learning-rate 0.0007 --update-epochs 10 --max-grad-norm 10
