...
python run.py --model "ppo_rec_global_critic" --env "full_communication_3" --experiment_name "main" --num-envs 256 --total-timesteps 12500 --learning-rate 0.0007 --update-epochs 10 --max-grad-norm 10 --episode_len 25 --wandb True #--load_weights_name "/ppo_rec_global_critic-full_communication_2-main"
