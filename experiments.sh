...
python run.py --model "ppo_shared_global_critic_rec_large" --env "complex_communication" --experiment_name "bigger" --num-envs 384 --total-timesteps 100000 --num-minibatches 1 --learning-rate 0.0007 --update-epochs 10 --max-grad-norm 10 --episode_len 50
