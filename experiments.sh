...
python run.py --model "ppo_shared_global_critic" --env "spread" --experiment_name "Big-Run" --num-envs 512 --total-timesteps 50000 --num-minibatches 1 --learning-rate 0.0007 --update-epochs 10 --max-grad-norm 10
