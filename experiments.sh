...
python run.py --model "ppo_shared_global_critic" --env "communication" --experiment_name "" --num-envs 256 --total-timesteps 25000 --num-minibatches 1 --learning-rate 0.0007 --update-epochs 10 --max-grad-norm 10
