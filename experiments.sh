...
python run.py --model "ppo_shared_global_critic" --env "communication" --experiment_name "4" --episode_len 25 --num-envs 128 --num-steps 100 --total-timesteps 50000 --num-minibatches 1 --learning-rate 0.0007 --update-epochs 10 --max-grad-norm 10
