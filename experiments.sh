...
python run.py --model "ppo_shared_global_critic_rec" --env "simple" --experiment_name "high-lr" --num-envs 512 --total-timesteps 15000 --num-minibatches 1 --learning-rate 0.0007 --update-epochs 1 --max-grad-norm 10
