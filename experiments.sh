...
python run.py --model "ppo_attend_agent" --env "full_communication_3" --experiment_name "test" --num-envs 512 --total-timesteps 6250 --learning-rate 0.0007 --update-epochs 10 --max-grad-norm 10 --episode_len 25 
