...
python run.py --model "maddpg" --env "communication" --experiment_name "v3-tanh-neg" --total_memory 12 --episode_len 50 --batch_size 4 --n_episodes 25000 --num_layers 3 --num_filters 128 --communicate 0 --n_epochs 3